    ...
    return (
        <div className="banner">
            ...
            <div className="mobile-button-bottom-container">
                ...
                <a className="mobile-button-bottom" style={{ textDecoration: 'none', marginTop: '5px', marginRight: '5px' }} target="_blank" rel="noopener noreferrer"  href="https://pay.eltrik.in/index.aspx"><Button style={{ marginTop: '5px', margin: 'auto' }} id="download-button" className="pay">Download Form</Button></a>
            </div>
