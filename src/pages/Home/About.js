            ...
            <div className="about-cases-container">
                <div className="about-case delhi">
                    <Card className="about-case-card">
                        <Grid container spacing={4}>
                            <Grid className="image-container" item xs={12} sm={4} lg={6}>
                                <img src={delhi} alt="Green Revolution" />
                            </Grid>
                            <Grid className="about-case-description" item xs={12} sm={8} lg={6}>
                ...
                <div className="about-case mumbai">
                    <Card className="about-case-card">
                        <Grid container spacing={4}>
                            <Grid className="image-container" item xs={12} sm={4} lg={6}>
                                <img src={windmills} alt="Delhi Pollutions" />
                            </Grid>
                            <Grid className="about-case-description" item xs={12} sm={8} lg={6}>
